...
| `timeframeControls`          | Optional | `ReactNode`                       | —       | Slot for date-range controls rendered by the host app |
| `setCostHref`                | Optional | `string`                          | —       | URL for the "Set Monthly Cost" action (hidden when omitted) |
