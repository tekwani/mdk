...
[client-paths]: ../../backend/core/client/README.md#when-to-use-which-client-path
<!-- docs@tether.io: client-paths → https://github.com/tetherto/mdk/blob/main/backend/core/client/README.md#when-to-use-which-client-path -->
