<!-- GENERATED FILE — DO NOT EDIT. For machine readable version see catalogue.json. Generated by backend/workers/scripts/generate-catalogue.js: run `npm run generate:catalogue` from the repo root. Source: backend/workers/**/mdk-contract.json and backend/workers/external-workers.json, validated against backend/core/mdk-worker/mdk-contract.schema.json. -->
